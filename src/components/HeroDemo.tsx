    ...
    <>
      <div className="hero-copy">
        ...
        <p className="hero-intro">
          Each agent works from its own computer. It can read the brief, use the
          tools, and return a draft for review. Your team stays in control.
        </p>
      ...
      <aside className="hero-bot-demo" aria-label="Live Grok Bot phone demo">
        <div className="hero-phone">
          ...
          <div className="hero-phone-thread" key={active.name}>
